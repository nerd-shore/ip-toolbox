...
export const getMonth = (date: any) => date.getMonth() + 1;
...
export const getBeginOfPreviousDecade = (date: any, offset: number = 10) => {
  const previousDecadeYear = getBeginOfDecadeYear(date) - offset;
  return getBeginOfDecade(previousDecadeYear);
};

export const getEndOfPreviousDecade = (date: any, offset: number = 10) => {
  const previousDecadeYear = getBeginOfDecadeYear(date) - offset;
  return getEndOfDecade(previousDecadeYear);
};

export const getBeginOfNextDecade = (date: any, offset: number = 10) => {
 ...
 * @param {Date} date Date.
 */
export const getYearRange = (date: any) => [
  getBeginOfYear(date),
  getEndOfYear(date),
];

export const getBeginOfPreviousYear = (date: any, offset: number = 1) => {
  const previousYear = getYear(date) - offset;
  return getBeginOfYear(previousYear);
};

export const getEndOfPreviousYear = (date: any, offset: number = 1) => {
  const previousYear = getYear(date) - offset;
  return getEndOfYear(previousYear);
};

export const getBeginOfNextYear = (date: any, offset: number = 1) => {
 ...
 */
export const getBeginOfWeek = (date: any, calendarType: string = 'ISO 8601') => {
  const year = getYear(date);
  const monthIndex = getMonthIndex(date);
 ...
 * @param {Date} date Date.
 */
export const getMonthRange = (date: any) => [
...
export const getBeginOfPreviousMonth = (date: any, offset: number = 1) => {
  const previousMonth = getDifferentMonth(date, -offset);
  return getBeginOfMonth(previousMonth);
};

export const getEndOfPreviousMonth = (date: any, offset: number = 1) => {
  const previousMonth = getDifferentMonth(date, -offset);
  return getEndOfMonth(previousMonth);
};

export const getBeginOfNextMonth = (date: any, offset: number= 1) => {
 ...
 * @param {Date} date Date.
 */
export const getDayRange = (date: any) => [
  getBeginOfDay(date),
  getEndOfDay(date),
];
 ...
 * @param {String} calendarType Calendar type. Can be ISO 8601 or US.
 */
export const getWeekNumber = (date: any, calendarType: string = 'ISO 8601') => {
  const beginOfWeek = getBeginOfWeek(date, calendarType) as any;
 ...
 * @param {Date} date Date.
 */
export const getBegin = (rangeType: string, date: any) => {
  switch (rangeType) {
    case 'century':
...
export const getBeginPrevious = (rangeType: string, date: any) => {
  switch (rangeType) {
    case 'century':
...
export const getBeginNext = (rangeType: string, date: any) => {
  switch (rangeType) {
    case 'century':
...
export const getBeginPrevious2 = (rangeType: string, date: any) => {
  switch (rangeType) {
    case 'decade':
...
export const getBeginNext2 = (rangeType: string, date: any) => {
  switch (rangeType) {
    case 'decade':
 ...
 * @param {Date} date Date.
 */
export const getEnd = (rangeType: string, date: any) => {
  switch (rangeType) {
    case 'century':
...
export const getEndPrevious = (rangeType: string, date: any) => {
  switch (rangeType) {
    case 'century':
...
export const getEndPrevious2 = (rangeType: string, date: any) => {
  switch (rangeType) {
    case 'decade':
 ...
 * @param {Date} date Date.
 */
export const getRange = (rangeType: string, date: any) => {
  switch (rangeType) {
    case 'century':
...
export const getValueRange = (rangeType: string, date1: any, date2: any) => {
  const rawNextValue = [date1, date2].sort((a: any, b: any) =>
 ...
 */
export const getISOLocalMonth = (value: string) => {
  if (!value) {
    return value;
  }
 ...
 */
export const getISOLocalDate = (value: string) => {
  if (!value) {
    return value;
  }
